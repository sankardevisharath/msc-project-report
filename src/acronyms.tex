...
\acro{XGBoost} {eXtreme Gradient Boosting Machine}
\acro{GRU} {Gated Recurrent Unit}
...
\acro{MSE}{Mean Squared Error}
\acro{BPTT}{Backpropogation Through Time}
\acro{BRNN}{Bidirectional Recurrent Neural Network}
\acro{LSTM}{Long Short-term Memory}
\acro{LS-SVM}{Least Square SVM}
\acro{CDGAT}{Graph attention network for credit card defaulters}
\acro{ML}{Machine Learning}
