...
In conclusion,   as reported in various studies \citep{alam2020investigation}, \citep{alam2020investigation}, \citep{emil2019enhancing}, the Ensemble Boosting techniques such as \acs{XGBoost} \& \acs{LGBM} provides best performance in terms of F1 Score \& computation for credit card default prediction problems. 
